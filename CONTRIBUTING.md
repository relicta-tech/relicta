...
- If changing `skills/` or skill-referenced workflows, complete the "Skill Publication Readiness" section and follow `docs/skill-publishing-checklist.md`

### Skill Proposals

- For new publicly discoverable skills, open an issue using `.github/ISSUE_TEMPLATE/public-skill-proposal.yml` before implementation.
