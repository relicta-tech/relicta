<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/relicta-tech/relicta/actions/workflows/codeql.yaml"><img src="https://img.shields.io/badge/nox-passing-4c1" alt="nox"></a>
    <a href="https://github.com/relicta-tech/relicta/actions/workflows/ci.yaml"><img src="https://img.shields.io/badge/coverctl-80.7%25-brightgreen" alt="coverctl"></a>
...
3. Evaluate risk using the Change Governance Protocol:

```bash
relicta evaluate
```

4. Generate release notes (optionally with AI):
