    ...
    <template v-else-if="release">
      ...
      >
        ...
        <div class="card">
          ...
          <div class="card-content">
            <div
              v-if="release.approval"
              class="space-y-4"
            >
              <div class="flex items-center gap-2">
                <svg
                  v-if="release.approval.approved"
                ...
                <span
                  v-if="release.approval.auto_approved"
              ...
              <div
                v-if="release.approval.approved_by"
                class="text-sm text-muted-foreground"
              >
                By: {{ release.approval.approved_by }}
              </div>
              <div
                v-if="release.approval.approved_at"
                class="text-sm text-muted-foreground"
              >
                At: {{ formatDate(release.approval.approved_at) }}
              </div>
              <div
                v-if="release.approval.justification"
          ...
          >
            ...
            >
              <div class="flex-1">
                <div class="flex items-center gap-2">
                  <span
                    v-if="commit.breaking"
                    class="badge bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400"
                  >
                    BREAKING
                  </span>
