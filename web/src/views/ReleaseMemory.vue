  ...
  <div class="space-y-6">
        ...
        <div class="card-content pt-6">
          <div class="flex items-center justify-between">
            ...
            <div :class="getTrendDirectionClass()">
              ...
              <svg
                v-else-if="getTrendDirectionIcon() === 'down'"
                class="h-6 w-6"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        <div
          v-else-if="!trends || trends.history.length === 0"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <p class="card-description">
            Risk patterns identified from release history
          </p>
        </div>
        <div class="card-content">
          <div
      ...
      <div class="card">
        ...
        <div class="card-content">
          ...
          <div
            v-else-if="recentOutcomes.length === 0"
            class="py-8 text-center text-muted-foreground"
          >
          ...
          >
            ...
            >
              <div class="flex items-center gap-3">
                <!-- Outcome icon -->
                <svg
                  v-if="getOutcomeIcon(outcome.outcome) === 'check'"
                ...
                <svg
                  v-else-if="getOutcomeIcon(outcome.outcome) === 'undo'"
                ...
                <svg
                  v-else-if="getOutcomeIcon(outcome.outcome) === 'alert'"
    ...
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">
          Release Insights Lookup
        </h2>
        <p class="card-description">
          Retrieve insights for a specific release by ID
        </p>
      </div>
      <div class="card-content">
        ...
        <div
          v-else-if="releaseInsights.length > 0"
        ...
        <div
          v-else-if="releaseIdInput.trim() && !loadingInsights"
