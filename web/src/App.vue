        ...
        >
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M6 3v12m0 0a3 3 0 103 3H9a3 3 0 003-3m-6 0h6m6-9a3 3 0 11-3 3h-3"
            />
          </svg>
          <svg
        ...
        >
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              <span :class="['h-2 w-2 rounded-full', getWsStatusColor()]" />
