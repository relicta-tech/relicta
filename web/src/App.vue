...
const navItems = [
  ...
  { path: '/repos', name: 'Repositories', icon: 'git-branch' },
  { path: '/observability', name: 'Observability', icon: 'activity' },
    ...
    >
      ...
      <nav class="flex-1 space-y-1 p-2">
        ...
        >
          ...
          <svg v-else-if="item.icon === 'chart-bar'" class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
          <svg v-else-if="item.icon === 'git-branch'" class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 3v12m0 0a3 3 0 103 3H9a3 3 0 003-3m-6 0h6m6-9a3 3 0 11-3 3h-3" />
          </svg>
          <svg v-else-if="item.icon === 'activity'" class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 12h-4l-3 9L9 3l-3 9H2" />
          </svg>
          <svg v-else-if="item.icon === 'brain'" class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
