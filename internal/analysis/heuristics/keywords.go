...
func initKeywordPatterns() map[changes.CommitType][]keywordPattern {
	return map[changes.CommitType][]keywordPattern{
		...
		changes.CommitTypeRefactor: {
			...
			{pattern: "optimize", position: "anywhere", confidence: 0.70, requireWordBoundary: true},
		...
		changes.CommitTypeDocs: {
			...
			{pattern: "readme", position: "anywhere", confidence: 0.85},
			...
			// Medium confidence
			{pattern: "typo", position: "anywhere", confidence: 0.86},
			{pattern: "spelling", position: "anywhere", confidence: 0.80},
			{pattern: "grammar", position: "anywhere", confidence: 0.80},
