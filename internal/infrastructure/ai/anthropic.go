//go:build relicta_anthropic || relicta_all_ai || !relicta_minimal
...
func init() {
	// Register Anthropic and Claude providers
	RegisterProvider("anthropic", NewAnthropicService)
	RegisterProvider("claude", NewAnthropicService)
}
