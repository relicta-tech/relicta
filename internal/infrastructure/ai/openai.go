//go:build relicta_openai || relicta_all_ai || !relicta_minimal
...
func init() {
	// Register OpenAI and Azure OpenAI providers
	RegisterProvider("openai", NewOpenAIService)
	RegisterProvider("azure-openai", NewOpenAIService)
}
