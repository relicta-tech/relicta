...
**Version:** 1.0
**Date:** 2025-12-17
**Status:** Historical Design Proposal (superseded in parts by current implementation)
...
### Original Problems (at proposal time)

1. **Two Separate "Managers"** - Runtime plugin loading (`internal/plugin/manager.go`) and CLI plugin management (`internal/plugin/manager/`) were not clearly integrated
