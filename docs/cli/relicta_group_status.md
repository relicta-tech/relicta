## relicta group status

Show release state of all repositories in group

### Synopsis

Display the current release state, version, and change status for each repository in the group.

```
relicta group status [flags]
```
