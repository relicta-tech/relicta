## relicta plugin registry disable

Disable a registry

### Synopsis

Disable a plugin registry without removing it. The official registry cannot be disabled.

```
relicta plugin registry disable <name> [flags]
```
