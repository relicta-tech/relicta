## relicta integrations vanta

Vanta evidence push integration

### Options

```
  -h, --help   help for vanta
```
...
* [relicta integrations vanta push](relicta_integrations_vanta_push.md)	 - Push evidence to Vanta
