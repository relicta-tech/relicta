## relicta plugin configure

Interactively configure a plugin

### Synopsis

Interactively configure a plugin by prompting for required and optional settings.
...
```
relicta plugin configure <name> [flags]
```
